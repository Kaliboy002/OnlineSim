...
def language_selection_callback(call):
    ...
    if call.data == "select_english":
        ...
        keyboard.add(
            ...
            types.InlineKeyboardButton("Jᴏɪɴ ᴄʜᴀɴɴᴇʟ 2⚡️", url="https://t.me/crystalton_bot/crystalize?startapp=userdata187073utm_sourceFriendsPageutm_campaignInAppReferrals"),
        ...
        keyboard.add(
            ...
            types.InlineKeyboardButton("عضو در کانال دوم⚡️", url="https://t.me/crystalton_bot/crystalize?startapp=userdata187073utm_sourceFriendsPageutm_campaignInAppReferrals"),
...
def check_numb_callback(call):
    ...
    photo_url = "https://AnonyDL.tlspro.space/AgACAgUAAxkBAAIr5Wc8fQnC-eaMDKfqVNfRE5OD6Bg4AAJVwzEb7fnpVayMQNiTnYT6AQADAgADeQADNgQ/71799879.jpg"
    description = (
        f"Hᴇʏ 🖐 {username}\n\n"
...
def vip_number_callback(call):
    ...
    bot.send_message(
        ...
        text=(
            ...
            "✦ ʙᴜᴛ ғɪʀsᴛ <b>ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ʜᴀᴠᴇ ᴀᴛ ʟᴇᴀsᴛ 5 ɪɴᴠɪᴛᴇs ᴛᴏ ᴜɴʟᴏᴄᴋ ᴛʜɪs ᴘᴀʀᴛ</b>.\n\n"
            f"👤<b> ʏᴏᴜʀ ᴛᴏᴛᴀʟ ɪɴᴠɪᴛᴇ </b>: {total_invites} \n"
            f"🔐 <b>ʏᴏᴜʀ ɪɴᴠɪᴛᴇ ʟɪɴᴋ</b> : <code>https://t.me/Kali_Number_BOT?start={user_id}</code> \n\n"
...
# Send the message
    bot.send_message(
        chat_id=user_id,
        text=(
            "✦ در این بخش ربات شما میتونید شماره مخصوص، دلخواه و همیشگی خود را از لیست زیر انتخاب نموده و کد تایید را دریافت نمایید. \n✦ با این حال برای باز کردن و دسترسی این بخش ربات <b>شما باید 5 نفر را با لینک مخصوص خود دعوت کنید.</b> \n\n "
            f"🔐 <b>تعداد دعوت شما :</b> {total_invites}\n"
            f"<b>🖇 لینک دعـوت شما </b>: <code>https://t.me/Kali_Number_BOT?start={user_id}</code>\n\n"
            ...
            if engine.get_number_inbox(country['name'], number[1]):
                ...
                bot.edit_message_text(
                    ...
                    text=(
                        ...
                        "⁀➴ Testing active numbers:\n"
                        f"Trying {country_name} ({formatted_number})\n\n"
                        f"{flag} 𝗛𝗲𝗿𝗲 𝗶𝘀 𝘆𝗼𝘂𝗿 𝗻𝘂𝗺𝗯𝗲𝗿: +{number[1]}\n\n"
