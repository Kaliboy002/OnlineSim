...
def vip_numberf_callback(call):
    ...
    bot.send_message(
        chat_id=user_id,
        text=("💎 در این بخش ربات شما میتونید شماره مخصوص، دلخواه و همیشگی خود را از لیست زیر انتخاب نموده و کد تایید را دریافت نماید، با این حال برای باز کردن و دسترسی این بخش ربات شما باید 5 نفر را با لینک مخصوص خود دعوت کنید\n\n🔐 <b>تعداد دعوت شما :</b> {total_invites} \n🖇 <b>لینک دعـوت شما </b>: {invite_link} \n\nلینک بالا را کپی و به دوستانتان برای دعوت بیشتر به اشتراک بگذارید🚀 "
        ),
        parse_mode="HTML",
        reply_markup=keyboard
    )
