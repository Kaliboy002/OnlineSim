...
# Send the message
    bot.send_message(
        ...
        text=(
            ...
            " نموده و کد تایید را دریافت نمایید. \n✦ با این حال برای باز کردن و دسترسی این بخش ربات <b>شما باید "
            "5 نفر را با لینک مخصوص خود دعوت کنید>b/>.\n\n"
            f"🔐 <b>تعداد دعوت شما :</b> {total_invites}\n"
            f"🖇 لینک دعـوت شما : code{invite_link}</code>\n\n"
